                ...
                <div id="content" class="site-content" role="main">
                    ...
                    <section class="error-404 not-found">
                        <header class="page-header">
                            ...
                            <h1 class="page-title"><?php _e( "Oops 404 again! That page can't be found.", 'houseofcoffee' ); ?></h1>
                        </header><!-- .page-header -->
        
                        <div class="page-content">
                            <p class="error-404-text"><?php _e( 'It looks like nothing was found at this location. Maybe try a search?', 'houseofcoffee' ); ?></p>
