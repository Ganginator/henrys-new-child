					<?php global $page_id, $woocommerce, $houseofcoffee_theme_options; ?>
                        ...
                        <div class="site-footer-copyright-area">
                            <div class="row">
								<div class="large-12 columns">
									...
									<?php if ( (isset($houseofcoffee_theme_options['footer_social_icons'])) && (trim($houseofcoffee_theme_options['footer_social_icons']) == "1" ) ) : ?>
                                    ...
                                    <div class="copyright_text">
                                        <?php if ( (isset($houseofcoffee_theme_options['footer_copyright_text'])) && (trim($houseofcoffee_theme_options['footer_copyright_text']) != "" ) ) { ?>
                                            <?php _e( $houseofcoffee_theme_options['footer_copyright_text'], 'houseofcoffee' ); ?>
                                        <?php } ?>
                                    </div><!-- .copyright_text -->  
        ...
        <nav class="st-menu slide-from-left <?php echo ( is_active_sidebar( 'catalog-widget-area' ) && ( isset($houseofcoffee_theme_options['sidebar_style']) && ( $houseofcoffee_theme_options['sidebar_style'] == "1" ) ) ) ? '//hide-for-large-up':''; ?> <?php echo ( is_active_sidebar( 'catalog-widget-area' ) ) ? 'shop-has-sidebar':''; ?>">
            <div class="nano">
                <div class="content">
                ...
                <div class="content">
                    ...
                    <div class="offcanvas_content_right">                	
                        ...
                        <div id="mobiles-menu-offcanvas">
							...
							<?php if ( (isset($houseofcoffee_theme_options['main_header_off_canvas'])) && (trim($houseofcoffee_theme_options['main_header_off_canvas']) == "1" ) ) : ?>
