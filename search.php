		...
		<div class="row">
			<div class="large-9 large-centered columns">
				...
				<header class="page-header">
					<h1 class="page-title search-results-title"><span class="top-page-excerpt"><?php printf( __( 'Search Results for %s', 'houseofcoffee' ), '<span class="page-title">' . get_search_query() . '</span>' ); ?></span></h1>
				</header><!-- .page-header -->
