		...
		<div class="article billing">
			<header>
						...
						<div style="float:left; width: 49%;">
							...
							<?php if (get_post_meta($order->id, 'VAT Number', TRUE) && $action == 'print_invoice') : ?>
								<strong><?php _e('VAT:', 'woocommerce-pip'); ?></strong> <?php echo get_post_meta($order->id, 'VAT Number', TRUE); ?><br/>
							<?php endif; ?>
							
							<?php if ($order->billing_email) : ?>
								<strong><?php _e('Email:', 'woocommerce-pip'); ?></strong> <?php echo $order->billing_email; ?><br/>
							<?php endif; ?>
							<?php if ($order->billing_phone) : ?>
								<strong><?php _e('Tel:', 'woocommerce-pip'); ?></strong> <?php echo $order->billing_phone; ?>
							<?php endif; ?>
							</p>
			...
			<table>
				...
				<tbody>
					<?php echo woocommerce_pip_custom_order_items_table($order); ?>
				</tbody>
			</table>
			<?php } ?>
			</div>
