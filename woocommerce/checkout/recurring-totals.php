...
?>
			...
			<tr class="recurring-totals">
				<td colspan="2" style="padding-left: 0; padding-right: 0;"><h2><?php esc_html_e( 'Subscription Totals', 'woocommerce-subscriptions' ); ?></h2></td>
			</tr>
		...
		<?php foreach ( $recurring_carts as $recurring_cart_key => $recurring_cart ) : ?>
			...
			<tr class="order-total recurring-total">
				<?php if ( $display_th ) : $display_th = false; ?>
				<th rowspan="<?php echo esc_attr( $carts_with_multiple_payments ); ?>"><?php esc_html_e( 'Subscription Total', 'woocommerce-subscriptions' ); ?></th>
				<?php endif; ?>
