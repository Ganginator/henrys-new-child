...
<div class="row">
    <div class="xxlarge-9 xlarge-10 large-12 large-centered columns">	
		...
		<!-- Facebook Conversion Code for Checkouts - HK -->
		<script>(function() {
		...
		window._fbq.push(['track', '6029002413835', {'value':'0.00','currency':'USD'}]);
		</script>
<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?ev=6029002413835&amp;cd[value]=0.00&amp;cd[currency]=USD&amp;noscript=1" /></noscript>
    </div><!-- .columns -->
</div><!-- .row -->
